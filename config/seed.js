...
(async function() {
  ...
  const types = await Type.create([
    ...
    {name: 'Grass', sortOrder: 40}, // 3
    {name: 'Electric', sortOrder: 50}, // 4
    {name: 'Ice', sortOrder: 60}, // 5
    {name: 'Fighting', sortOrder: 70}, // 6
    {name: 'Poison', sortOrder: 80}, // 7
    {name: 'Ground', sortOrder: 90}, // 8
    {name: 'Flying', sortOrder: 100}, // 9
    {name: 'Psychic', sortOrder: 110}, // 10
    {name: 'Bug', sortOrder: 120}, // 11
    {name: 'Rock', sortOrder: 130}, // 12
    {name: 'Ghost', sortOrder: 140}, // 13
    {name: 'Dark', sortOrder: 150}, // 14
    {name: 'Dragon', sortOrder: 160}, // 15
    {name: 'Steel', sortOrder: 170}, // 16
  ...
  const pokemons = await Pokemon.create([
    ...
    {name: 'Weedle', img: 'https://archives.bulbagarden.net/media/upload/thumb/3/36/0013Weedle.png/70px-0013Weedle.png', type: [types[11], types[7]], price: 20},
    {name: 'Pidgey', img: 'https://archives.bulbagarden.net/media/upload/thumb/0/0c/0016Pidgey.png/70px-0016Pidgey.png', type: [types[0], types[9]], price: 10},
    ...
    {name: 'Spearow', img: 'https://archives.bulbagarden.net/media/upload/thumb/2/2d/0021Spearow.png/70px-0021Spearow.png', type: [types[0], types[9]], price: 20},
    ...
    {name: 'Jigglypuff', img: 'https://archives.bulbagarden.net/media/upload/thumb/3/3a/0039Jigglypuff.png/70px-0039Jigglypuff.png', type: [types[0], types[17]], price: 2000},
    {name: 'Zubat', img: 'https://archives.bulbagarden.net/media/upload/thumb/4/4c/0041Zubat.png/70px-0041Zubat.png', type: [types[9], types[7]], price: 80},
    {name: 'Oddish', img: 'https://archives.bulbagarden.net/media/upload/thumb/1/16/0043Oddish.png/70px-0043Oddish.png', type: [types[3], types[7]], price: 30},
    {name: 'Paras', img: 'https://archives.bulbagarden.net/media/upload/thumb/8/8a/0046Paras.png/70px-0046Paras.png', type: [types[11], types[3]], price: 10},
    {name: 'Venonat', img: 'https://archives.bulbagarden.net/media/upload/thumb/2/2c/0048Venonat.png/70px-0048Venonat.png', type: [types[11], types[7]], price: 5000},
    ...
    {name: 'Bellsprout', img: 'https://archives.bulbagarden.net/media/upload/thumb/6/66/0069Bellsprout.png/70px-0069Bellsprout.png', type: [types[3], types[7]], price: 20},
    {name: 'Tentacool', img: 'https://archives.bulbagarden.net/media/upload/thumb/6/6e/0072Tentacool.png/70px-0072Tentacool.png', type: [types[2], types[7]], price: 50},
    {name: 'Geodude', img: 'https://archives.bulbagarden.net/media/upload/thumb/9/97/0074Geodude.png/70px-0074Geodude.png', type: [types[12], types[8]], price: 50},
    ...
    {name: 'Slowpoke', img: 'https://archives.bulbagarden.net/media/upload/thumb/1/19/0079Slowpoke.png/70px-0079Slowpoke.png', type: [types[2], types[10]], price: 2000},
    {name: 'Magnemite', img: 'https://archives.bulbagarden.net/media/upload/thumb/a/a2/0081Magnemite.png/70px-0081Magnemite.png', type: [types[4], types[16]], price: 20},
    {name: `Farfetch'd`, img: 'https://archives.bulbagarden.net/media/upload/thumb/9/99/0083Farfetch%27d.png/70px-0083Farfetch%27d.png', type: [types[0], types[9]], price: 150},
    {name: 'Doduo', img: 'https://archives.bulbagarden.net/media/upload/thumb/b/b9/0084Doduo.png/70px-0084Doduo.png', type: [types[0], types[9]], price: 1000},
    ...
    {name: 'Gastly', img: 'https://archives.bulbagarden.net/media/upload/thumb/c/c2/0092Gastly.png/70px-0092Gastly.png', type: [types[13], types[7]], price: 10},
    {name: 'Onix', img: 'https://archives.bulbagarden.net/media/upload/thumb/b/b7/0095Onix.png/70px-0095Onix.png', type: [types[12], types[8]], price: 7000},
    ...
    {name: 'Exeggcute', img: 'https://archives.bulbagarden.net/media/upload/thumb/a/ae/0103Exeggutor.png/70px-0103Exeggutor.png', type: [types[4], types[10]], price: 10},
    ...
    {name: 'Scyther', img: 'https://archives.bulbagarden.net/media/upload/thumb/8/81/0123Scyther.png/70px-0123Scyther.png', type: [types[11], types[9]], price: 500},
    ...
    {name: 'Lapras', img: 'https://archives.bulbagarden.net/media/upload/thumb/9/99/0131Lapras.png/70px-0131Lapras.png', type: [types[2], types[5]], price: 5000},
